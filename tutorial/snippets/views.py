...
class SnippetListMix(mixins.ListModelMixin, mixins.CreateModelMixin, generics.GenericAPIView):
...
class SnippetDetailMix(mixins.RetrieveModelMixin, mixins.UpdateModelMixin, mixins.DestroyModelMixin,
